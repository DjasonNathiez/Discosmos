...
public class FieldOfView : MonoBehaviour
{
	...
	{
		isStatic = true;
		if (meshResolution != 0 || viewRadius != 0)
		{
			DrawFieldOfView();
		}
	}
    ...
    void FindVisibleTargets ()
	{
		...
		for (int i = 0; i < targetsInViewRadius.Length; i++)
		{
			...
			if (Physics.Raycast(transform.position, dirToTarget1, dstToTarget, targetMask) || Physics.Raycast(transform.position, dirToTarget2, dstToTarget, targetMask))
			{
